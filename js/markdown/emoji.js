...
(function (global, factory) {
	...
	var replace = function create_rule(md, emojies, scanRE, replaceRE) {
	...
	var normalize_opts = function normalize_opts(options) {
	  ...
	  if(dbr_emojis) {
		  emojies = Object.assign(emojies, dbr_emojis);
	  }
	...
	var bare = function emoji_plugin(md, options) {
	  ...
	  md.core.ruler.push('emoji', replace(md, opts.defs, opts.scanRE, opts.replaceRE));
	};
  
	var markdownItEmoji = function emoji_plugin(md, options) {
	  var defaults = {
		defs: discord_emojis_list,
		enabled: []
	  };
